...
export class CameraController {
  ...
  update(deltaTime, playerPosition, playerVelocity, playerHeading, edgeAngle = 0, isGrounded = true, compression = 0, wasGrounded = true) {
    ...
    // This is the key to smooth camera - orbit rotates slowly like a lazy susan
    ...
    const targetX = playerPosition.x - Math.sin(this.orbitAngle) * this.distance;
    const targetZ = playerPosition.z - Math.cos(this.orbitAngle) * this.distance;
    const targetY = playerPosition.y + this.height;
